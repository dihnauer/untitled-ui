export function Logo() {
  return (
    <strong className="flex items-center gap-2 text-xl font-semibold text-zinc-900">
      ...
      >
        <g filter="url(#filter0_dd_2962_307)">
          <g clip-path="url(#clip0_2962_307)">
            ...
            <rect
              ...
              height="32"
              rx="8"
              fill="url(#paint0_linear_2962_307)"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
            ...
            <path
              ...
              fill="#D0D5DD"
            />
            <g filter="url(#filter1_dd_2962_307)">
              <circle
                cx="19"
                cy="18"
                r="8"
                fill="url(#paint1_linear_2962_307)"
              />
            </g>
            <g filter="url(#filter2_b_2962_307)">
              <path
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_2962_307"
            />
            <feColorMatrix
              in="SourceAlpha"
              type="matrix"
            ...
            <feBlend
              mode="normal"
              in2="effect1_dropShadow_2962_307"
              result="effect2_dropShadow_2962_307"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect2_dropShadow_2962_307"
              result="shape"
            />
          </filter>
          <filter
            id="filter1_dd_2962_307"
            x="8"
            y="8"
            width="22"
            height="22"
          ...
          >
            ...
            <feComposite
              in2="SourceAlpha"
              operator="in"
              result="effect1_backgroundBlur_2962_307"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_backgroundBlur_2962_307"
              result="shape"
            />
          </filter>
          <linearGradient
            id="paint0_linear_2962_307"
            x1="19"
            y1="2"
            x2="19"
            y2="34"
